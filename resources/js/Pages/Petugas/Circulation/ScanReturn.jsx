...
import { ArrowLeft, ArrowRightLeft, CheckCircle2, AlertCircle, DollarSign, Calendar, Clock, BookOpen, ArrowRight } from 'lucide-react';
...
export default function ScanReturn() {
    ...
    const returnReceipt = flash?.return_receipt;

    return (
        <PetugasLayout activeMenu="circulations">
            <Head title="Validasi Pengembalian Buku Fisik" />
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h1 className="text-xl font-black text-slate-950 tracking-tight">Meja Pengembalian Koleksi Fisik</h1>
                    ...
                    >
                        <span>Pindah ke Scan Tiket HP</span>

...
export default function NationalJournalsCreate({
    prodiList = [],
    nationalIndexings = [],
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post('/petugas/national-journals');
    };
    ...
    return (
        <PetugasLayout activeMenu="national-journals">
            <Head title="Tambah Publikasi Ilmiah - SIMPUS Petugas" />
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <div className="inline-flex items-center space-x-1.5 text-xs font-bold text-amber-700">
                                ...
                                <span>Direktori Publikasi Ilmiah</span>
                            </div>
                            <h1 className="text-2xl font-black text-slate-950 tracking-tight">
                                Tambah {data.journal_type === 'Prosiding' ? 'Prosiding Seminar' : `Jurnal ${data.journal_type}`} Baru
                            </h1>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        >
                            ...
                            <span>{processing ? 'Menyimpan...' : 'Simpan Data Publikasi'}</span>
                        </button>
                    </div>
                </div>
                        ...
                        <div className="bg-white p-6 sm:p-8 rounded-3xl border border-amber-900/10 shadow-sm space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder={
                                        data.journal_type === 'Prosiding'
                                            ? 'Contoh: Prosiding Seminar Nasional Vokasi & Rekayasa Teknologi Terapan (SNV-RTT)...'
                                            : data.journal_type === 'Internasional'
                                            ? 'Contoh: International Journal of Applied Computer Science and Software Engineering...'
                                            : 'Contoh: INFOKES: Jurnal Ilmiah Rekam Medis dan Informatika Kesehatan...'
                                    }
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <input
                                        ...
                                        placeholder="Contoh: LPPM Politeknik Indonusa Surakarta"
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        placeholder="https://prosiding.poltekindonusa.ac.id/..."

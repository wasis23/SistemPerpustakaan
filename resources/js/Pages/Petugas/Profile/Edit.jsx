...
export default function Edit({ user }) {
    ...
    // Form Update Data Diri Pustakawan
    ...
    // Form Ganti Password Pustakawan
    ...
    const handleProfileSubmit = (e) => {
        e.preventDefault();
        profileForm.patch('/petugas/profile', {
            preserveScroll: true,
        });
    };
    ...
    const handlePasswordSubmit = (e) => {
        e.preventDefault();
        passwordForm.put('/petugas/profile/password', {
            preserveScroll: true,
            onSuccess: () => {
                passwordForm.reset();
            },
    ...
    return (
        <PetugasLayout activeMenu="profile">
            <Head title="Pengaturan Profil & Password Pustakawan" />
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 sm:p-8 rounded-3xl border border-slate-200/80 shadow-sm">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 className="font-extrabold text-slate-950 text-xl sm:text-2xl tracking-tight">
                                Profil & Keamanan Pustakawan
                            </h1>
                            <p className="text-xs text-slate-500 font-medium mt-0.5">
                                Kelola informasi akun, kontak resmi, dan ganti kata sandi login Anda
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-2 bg-slate-50 border border-slate-200 px-3.5 py-2 rounded-2xl">
                        ...
                        <span className="text-xs font-bold text-slate-700 font-mono">
                            ID: <span className="text-amber-800 font-black">{user.username}</span>
                        </span>
                    </div>
                </div>
                            ...
                            <form onSubmit={handleProfileSubmit} className="space-y-4">
                                <div>
                                    ...
                                    <span className="text-[10px] text-slate-400 mt-1 block">
                                        Username akun sistem bersifat permanen.
                                    </span>
                                </div>

                                <div>
                                    <label className="block text-xs font-bold text-slate-700 mb-1.5">
                                        Nama Lengkap Pustakawan <span className="text-rose-500">*</span>
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="email@poltekindonusa.ac.id"
                                        className="w-full px-4 py-3 bg-slate-50 border border-slate-300 rounded-2xl text-xs font-medium text-slate-900 focus:outline-none focus:border-amber-500"
                                        required
                                    />
                            ...
                            <form onSubmit={handlePasswordSubmit} className="space-y-4">
                                ...
                                <div className="pt-2">
                                    ...
                                    >
                                        ...
                                        <span>{passwordForm.processing ? 'Memperbarui...' : 'Perbarui Password Pustakawan'}</span>
                                    </button>
                                </div>
                            </form>
                        </div>
